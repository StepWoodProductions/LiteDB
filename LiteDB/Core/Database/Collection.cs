...
namespace LiteDB
{
    public partial class LiteDatabase : IDisposable
    {
        ...
        public LiteCollection<T> GetCollection<T>(string name)
            where T : new()
        {
            if (StringExtensions.IsNullOrWhiteSpace(name)) throw new ArgumentNullException("name");
        ...
        {
            if (StringExtensions.IsNullOrWhiteSpace(oldName)) throw new ArgumentNullException("oldName");
            if (StringExtensions.IsNullOrWhiteSpace(newName)) throw new ArgumentNullException("newName");
